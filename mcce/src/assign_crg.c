...
/** assign charges to all the atoms in protein, get the vale of the "crg" filed of the ATOM structure
 * 	from the topology file filed "CHARGE" by the conformer name of the atom and atom name.
 */
